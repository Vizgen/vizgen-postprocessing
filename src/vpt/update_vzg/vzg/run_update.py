...
from vpt.update_vzg.vzg.assemble.dataset_assemble import identify_sequential, run_dataset_assembling
from vpt.update_vzg.vzg.cell_metadata import CellMetadata
from vpt.update_vzg.vzg.imageparams import ImageParams, load_image_parameters
from vpt.update_vzg.vzg.polygon_transfer import CellsTransfer, CellTransfer
from vpt.update_vzg.vzg.polygons.packedpolygon import LodLevel
from vpt.update_vzg.vzg.polygons.polygonset import PolygonSet
...
def update_vzg(args: UpdateVzgArgs, features: list):
