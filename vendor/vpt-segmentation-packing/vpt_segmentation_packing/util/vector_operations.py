""" Module for various vector operations used in polygon partition, filtration"""
import math
...
def point_in_sector(pointVec, leftSectorDir, rightSectorDir) -> bool:
    ...
    return pseudo_scalar(pointVec, leftSectorDir) >= 0 and pseudo_scalar(pointVec, rightSectorDir) <= 0
...
def polygon_area(x, y) -> float:
    """Calculates area of polygon set by 2-dimensions.
    Returns:
         Polygon area.
    """
