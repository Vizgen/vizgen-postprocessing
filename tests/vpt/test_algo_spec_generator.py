...
def test_template_whitespaces() -> None:
    ...
    with open(f"{os.path.dirname(__file__)}/data/integration/cellpose_2.json", "r") as f:
...
def test_custom_parameters() -> None:
    ...
    blur_filter = {"name": "blur", "parameters": {"size": 6}}
    custom_parameters = {
        "segmentation_tasks.0.z_layers": [1, 3, 5],
...
def test_invalid_template_parameters() -> None:
    template_name = "cellpose_default"
    template_parameters = {"entity_types": "cell", "seg_model": "cyto2", "nuclear_channel": "DAPI"}
...
def test_set_z_levels() -> None:
    ...
    result1 = {"all_z_indexes": [0, 1, 2], "z_positions_um": [1.5, 3.0, 4.5]}
    ...
    result2 = {"all_z_indexes": [0, 2, 4, 6], "z_positions_um": [1, 2, 3, 4]}
    ws_template_parameters = {
        "entity_types_detected": "cell",
        "stardist_model": "SDM",
        "entity_fill_channel": "X",
        "seed_channel": "Y",
