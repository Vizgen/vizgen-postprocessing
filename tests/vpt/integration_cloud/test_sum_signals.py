...
from tests.vpt.integration_cloud import TEST_GCS_PATH, TEST_S3_BUCKET_PATH
from tests.vpt.temp_dir import CloudTempDir
from tests.vpt.test_sum_signals import SumSignalsCase, SumSignalsCaseScheme, setup_from_scheme, test_sum_signals
...
SUM_SIGNALS_TEST_SCHEMES = [
    ...
    for name, tmp_dir in zip(["s3", "gcs"], [CloudTempDir(TEST_S3_BUCKET_PATH), CloudTempDir(TEST_GCS_PATH)])
]
