from vpt.run_segmentation_on_tile.output_utils import update_entity_id, get_entity_type_code
...
def test_entity_id_overflow() -> None:
    ...
    try:
        sr.update_column(SegmentationResult.cell_id_field, update_entity_id, tile='8834',
                         time='43049737', entity_type=get_entity_type_code(sr.entity_type))
        assert False
    except Exception:
        return
